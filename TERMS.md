...
Marketplace packages are supplied by their repository publishers, not by the
AI Marketplace software. Review package source, permissions, instructions, and
applicable third-party terms before installation. Do not use credentials or
repositories you are not authorized to access.

The software is provided "as is", without warranties or guarantees of
availability, fitness, security, or compatibility. To the maximum extent
