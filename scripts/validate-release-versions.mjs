...
const releases = [
  ...
  { label: "Visual Studio extension", manifest: "packages/visualstudio-plugin/package.json", affected: (path) => path.startsWith("packages/marketplace-core/src/") || path.startsWith("packages/marketplace-node-cli/src/") || path.startsWith("plugins/ai-marketplace/src/") || path.startsWith("plugins/ai-marketplace/dashboard/") || path.startsWith("packages/visualstudio-plugin/") || path === "scripts/visualstudio.mjs" },
